...
class PaymentCard {
  ...
  String get maskedNumber =>
      '**** **** **** ${number.padLeft(4).substring(number.length >= 4 ? number.length - 4 : 0)}';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // Summary (lightweight, you can pass full breakdown if you want)
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: selected
                ? [
                    cs.primary.withOpacity(.12),
                    cs.primaryContainer.withOpacity(.2),
                  ]
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        }.expand((w) => [w]).toList(), // neat trick to keep consts tidy
      ),
    );
  }
}
        ...
        TextFormField(
          ...
          onChanged: inputFormat == null
              ...
              : (v) {
                  ...
                  controller.text = inputFormat!(v);
                  controller.selection = TextSelection.collapsed(
                    offset: controller.text.length.clamp(
                      0,
