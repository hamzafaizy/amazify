...
import 'package:amazify/features/cart/presentation/pages/cart_page.dart'; // for CartItem
...
class _SummaryRow extends StatelessWidget {
  ...
  /// If null, uses theme body font size.
  final double? size;

  @override
  Widget build(BuildContext context) {
    final base = Theme.of(context).textTheme.bodyMedium ?? const TextStyle();
    final resolvedSize = size ?? base.fontSize ?? 14;
